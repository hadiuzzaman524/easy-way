...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppThemeState&&(identical(other.isDarkTheme, isDarkTheme) || other.isDarkTheme == isDarkTheme));
}
...
@override
String toString() {
  return 'AppThemeState(isDarkTheme: $isDarkTheme)';
}
...
class _AppThemeState implements AppThemeState {
  const _AppThemeState({required this.isDarkTheme});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppThemeState&&(identical(other.isDarkTheme, isDarkTheme) || other.isDarkTheme == isDarkTheme));
}
